...
public class ForgetActivity extends AppCompatActivity {
    ...
    private TextView textViewForgetBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewForgetBack = findViewById(R.id.textViewForgetBack);
        ...
        textViewForgetBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
